...
The app also enforces a launch-time check (per `PLAN.md` Global Constraints): jobs refuse to start if free disk is <150 GB, with a clear error message. This is a hard gate independent of the ≥200 GB recommendation.
